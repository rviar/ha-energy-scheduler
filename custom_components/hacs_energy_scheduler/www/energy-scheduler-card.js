      ...
      <div class="schedule-tab">
        ...
        <div class="controls-bar">
          <select class="controls-select" .value=${b} @change=${this._handleIntervalChange}>
            ...
            <option value="hourly" ?selected=${"hourly"===b}>Hourly</option>
            <option value="6h" ?selected=${"6h"===b}>Every 6h</option>
            <option value="daily" ?selected=${"daily"===b}>Daily</option>
            <option value="reactive" ?selected=${"reactive"===b}>Reactive</option>
          </select>
          ${v.length>0?U`
