...
class EnergySchedulerOptionsFlow(config_entries.OptionsFlow):
        ...
        data_schema = vol.Schema(
            {
                ...
                vol.Optional(
                    CONF_INVERTER_EXPORT_SURPLUS_SWITCH,
                    description={"suggested_value": current_config.get(CONF_INVERTER_EXPORT_SURPLUS_SWITCH)},
                ): selector.EntitySelector(
                    selector.EntitySelectorConfig(domain=["switch", "input_boolean"])
                ),
                vol.Optional(
                    CONF_INVERTER_PV_INPUT_SWITCH,
                    description={"suggested_value": current_config.get(CONF_INVERTER_PV_INPUT_SWITCH)},
                ): selector.EntitySelector(
                    selector.EntitySelectorConfig(domain=["switch", "input_boolean"])
                ),
                vol.Optional(
                ...
                vol.Required(
                    CONF_CURRENCY,
                    default=current_config.get(CONF_CURRENCY, DEFAULT_CURRENCY),
    ...
    async def async_step_battery(
        ...
        errors: dict[str, str] = {}
        current_config = self._get_current_config()
        currency = current_config.get(CONF_CURRENCY, DEFAULT_CURRENCY)
        ...
        data_schema = vol.Schema(
            {
                ...
                vol.Optional(
                    CONF_MIN_SELL_PRICE,
                    default=current_config.get(CONF_MIN_SELL_PRICE, DEFAULT_MIN_SELL_PRICE),
                ): selector.NumberSelector(
                    selector.NumberSelectorConfig(
                        min=-1.0,
                        max=5.0,
                ...
                vol.Optional(
                    CONF_MIN_DISCHARGE_ENERGY,
                    default=current_config.get(CONF_MIN_DISCHARGE_ENERGY, DEFAULT_MIN_DISCHARGE_ENERGY),
                ): selector.NumberSelector(
                    selector.NumberSelectorConfig(
                        min=0.0,
                        max=3.0,
        ...
        data_schema = vol.Schema(
            {
                ...
                vol.Optional(
                    CONF_PV_FORECAST_TOMORROW_SENSOR,
                    description={"suggested_value": current_config.get(CONF_PV_FORECAST_TOMORROW_SENSOR)},
                ): selector.EntitySelector(
                    selector.EntitySelectorConfig(domain="sensor")
                ),
                vol.Optional(
                ...
                vol.Optional(
                    CONF_CONSUMPTION_SENSOR,
                    description={"suggested_value": current_config.get(CONF_CONSUMPTION_SENSOR)},
                ): selector.EntitySelector(
                    selector.EntitySelectorConfig(domain="sensor")
                ),
                vol.Optional(
                    CONF_EV_CHARGER_CONSUMPTION_SENSOR,
                    description={"suggested_value": current_config.get(CONF_EV_CHARGER_CONSUMPTION_SENSOR)},
                ): selector.EntitySelector(
                    selector.EntitySelectorConfig(domain="sensor")
                ),
                vol.Optional(
                    CONF_LOAD_POWER_SENSOR,
                    description={"suggested_value": current_config.get(CONF_LOAD_POWER_SENSOR)},
                ): selector.EntitySelector(
                    selector.EntitySelectorConfig(domain="sensor")
                ),
                vol.Optional(
                    CONF_BREAKER_POWER_LIMIT,
                    default=current_config.get(CONF_BREAKER_POWER_LIMIT, DEFAULT_BREAKER_POWER_LIMIT),
                ): selector.NumberSelector(
                    selector.NumberSelectorConfig(
                        min=0,
                        max=100,
                ...
                vol.Optional(
                    CONF_PV_PRODUCTION_SENSOR,
                    description={"suggested_value": current_config.get(CONF_PV_PRODUCTION_SENSOR)},
                ): selector.EntitySelector(
                    selector.EntitySelectorConfig(domain="sensor")
                ),
                vol.Optional(
                ...
                vol.Optional(
                    CONF_PV_CONFIDENCE_FACTOR,
                    default=current_config.get(CONF_PV_CONFIDENCE_FACTOR, DEFAULT_PV_CONFIDENCE_FACTOR),
                ): selector.NumberSelector(
                    selector.NumberSelectorConfig(
                        min=50,
                        max=100,
    ...
    async def async_step_ev(
        ...
        if user_input is not None:
            ...
            if ev_enabled:
                ...
                low = user_input.get(CONF_PRIORITY_HOME_LOW_THRESHOLD, DEFAULT_PRIORITY_HOME_LOW)
                high = user_input.get(CONF_PRIORITY_HOME_HIGH_THRESHOLD, DEFAULT_PRIORITY_HOME_HIGH)
                if low >= high:
                    errors["base"] = "home_low_must_be_less_than_high"

                # Validate min amps < max amps
                min_a = user_input.get(CONF_EV_MIN_CHARGE_AMPS, DEFAULT_EV_MIN_CHARGE_AMPS)
                max_a = user_input.get(CONF_EV_MAX_CHARGE_AMPS, DEFAULT_EV_MAX_CHARGE_AMPS)
                if min_a >= max_a:
                    errors["base"] = "ev_min_amps_must_be_less_than_max"
        ...
        data_schema = vol.Schema(
            {
                ...
                vol.Optional(
                    CONF_PRIORITY_HOME_LOW_THRESHOLD,
                    default=current_config.get(CONF_PRIORITY_HOME_LOW_THRESHOLD, DEFAULT_PRIORITY_HOME_LOW),
                ): selector.NumberSelector(
                    selector.NumberSelectorConfig(
                ...
                vol.Optional(
                    CONF_PRIORITY_HOME_HIGH_THRESHOLD,
                    default=current_config.get(CONF_PRIORITY_HOME_HIGH_THRESHOLD, DEFAULT_PRIORITY_HOME_HIGH),
                ): selector.NumberSelector(
                    selector.NumberSelectorConfig(
                ...
                vol.Optional(
                    CONF_PRIORITY_EV_HIGH_THRESHOLD,
                    default=current_config.get(CONF_PRIORITY_EV_HIGH_THRESHOLD, DEFAULT_PRIORITY_EV_HIGH),
                ): selector.NumberSelector(
                    selector.NumberSelectorConfig(
                ...
                vol.Optional(
                    CONF_EV_CHARGE_ENTITY,
                    description={"suggested_value": current_config.get(CONF_EV_CHARGE_ENTITY)},
                ): selector.EntitySelector(
                    selector.EntitySelectorConfig(domain=["switch", "input_boolean"])
                ),
                vol.Optional(
                    CONF_EV_AMPS_ENTITY,
                    description={"suggested_value": current_config.get(CONF_EV_AMPS_ENTITY)},
                ): selector.EntitySelector(
                    selector.EntitySelectorConfig(domain=["number", "input_number"])
                ),
                vol.Optional(
                    CONF_EV_MAX_CHARGE_AMPS,
                    default=current_config.get(CONF_EV_MAX_CHARGE_AMPS, DEFAULT_EV_MAX_CHARGE_AMPS),
                ): selector.NumberSelector(
                    selector.NumberSelectorConfig(
                        min=6, max=32, step=1,
                ...
                vol.Optional(
                    CONF_EV_MIN_CHARGE_AMPS,
                    default=current_config.get(CONF_EV_MIN_CHARGE_AMPS, DEFAULT_EV_MIN_CHARGE_AMPS),
                ): selector.NumberSelector(
                    selector.NumberSelectorConfig(
                        min=3, max=16, step=1,
                        unit_of_measurement="A",
                ...
                vol.Optional(
                    CONF_EV_VOLTAGE,
                    default=current_config.get(CONF_EV_VOLTAGE, DEFAULT_EV_VOLTAGE),
                ): selector.NumberSelector(
                    selector.NumberSelectorConfig(
    ...
    async def async_step_modes(
        ...
        schema_dict = {
            ...
            vol.Optional(
                CONF_MODE_SELF_CONSUME,
                description={"suggested_value": current_config.get(CONF_MODE_SELF_CONSUME)},
            ): selector.SelectSelector(
                selector.SelectSelectorConfig(
                    options=available_modes,
                    mode=selector.SelectSelectorMode.DROPDOWN,
